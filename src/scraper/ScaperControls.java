...
class ScaperControls {
	...
	private static void controlFirstIfInSecondForGetFixtureFull(Elements rowsHome, String homeTeam, ExtendedFixture fix, ArrayList<PlayerFixture> playerFixtures,
			String name, String homeTeam) {
	...
	static void controlSecondForGetFixtureFull(Elements rowsHome, String homeTeam, ExtendedFixture fix,
			ArrayList<PlayerFixture> playerFixtures, String homeTeam) {
		for (int i = 1; i < rowsHome.size(); i++) {
			...
			controlFirstIfInSecondForGetFixtureFull(rowsHome, homeTeam, fix, playerFixtures, name, homeTeam);
		}
	}
